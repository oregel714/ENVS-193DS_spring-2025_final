...
In part 2, they used an Analysis of Variance (ANOVA) to determine if there is a difference between the sources of nitrogen and average nitrogen load. 
...
The best model as determined by Akaike's Information Criterion (ACI) uses season and edge distance (F(0.23, 0.89), )



```{r summarizing model coefficients}
